export const en = {
  translation: {
    ...
    language_invalid: 'Invalid language. Available languages: cs, de, en, es, fr, it, nl, pl, pt, sv',
    language_missing: 'Please provide a language (cs, de, en, es, fr, it, nl, pl, pt or sv).',
